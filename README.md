...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-geocoder.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-geocoder)
...
```bash
php artisan vendor:publish --tag="laravel-geocoder-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="laravel-geocoder-views"
```

## Usage

```php
$laravelGeocoder = new Clevyr\LaravelGeocoder();
echo $laravelGeocoder->echoPhrase('Hello, Clevyr!');
```
